...
public class DefaultSecurityFilter extends AbstractConfigFilter implements SecurityEndpoint {
    ...
    @Inject
    public DefaultSecurityFilter(Config config, io.micronaut.session.SessionStore<Session> sessionStore, HttpSessionIdResolver[] resolvers) {
