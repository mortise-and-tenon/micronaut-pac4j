...
public class DefaultCallbackFilter extends AbstractConfigFilter {
    ...
    public DefaultCallbackFilter() {
    }

    @Inject
    public DefaultCallbackFilter(Config config, io.micronaut.session.SessionStore<Session> sessionStore, HttpSessionIdResolver[] resolvers) {
